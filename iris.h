...
inline std::ostream& operator<<(std::ostream& _out, const Labels& type)
{
    ...
    case Labels::Setosa:
        return _out << "Setosa";
    case Labels::Versicolor:
        return _out << "Versicolor";
    case Labels::Virginica:
        return _out << "Virginica";
    default:
        return _out << "None";
    }
}
...
inline std::istream& operator>>(std::istream& _in, knn::Entity<double, 4, Labels, int>& entity)
{
    ...
    case 11:
        entity.label = Labels::Setosa;
        break;
    case 15:
        entity.label = Labels::Versicolor;
        break;
    case 14:
        entity.label = Labels::Virginica;
        break;
    }
    return _in;
}
